...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.err.println(
                    "Failed to connect to the database. Make sure you are connected to the VPN if you are not on campus.");
            System.exit(1);
    ...
    public static void part8(Warehouse theWarehouse, Deliveries theDeliveries) {
        ...
        List<Integer> outstandingDeliveries = theDeliveries.getOutstandingDeliveryNumbers();
